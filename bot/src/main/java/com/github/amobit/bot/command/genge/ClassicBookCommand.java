...
public class ClassicBookCommand extends Command {
    public final static String genre = "Классическая-литература";
    ...
    public ClassicBookCommand(SendBotMessageService sendBotMessageService, BookService bookService) {
