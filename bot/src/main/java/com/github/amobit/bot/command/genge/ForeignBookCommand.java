...
public class ForeignBookCommand extends Command {
    public final static String genre = "Зарубежная-литература";
    ...
    public ForeignBookCommand(SendBotMessageService sendBotMessageService, BookService bookService) {
