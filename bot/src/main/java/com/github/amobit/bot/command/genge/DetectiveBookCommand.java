...
public class DetectiveBookCommand extends Command {
    public final static String genre = "Детективы";
    ...
    public DetectiveBookCommand(SendBotMessageService sendBotMessageService, BookService bookService) {
