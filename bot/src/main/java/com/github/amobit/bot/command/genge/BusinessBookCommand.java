...
public class BusinessBookCommand extends Command {

    public final static String genre = "Бизнес-книги";
    ...
    public BusinessBookCommand(SendBotMessageService sendBotMessageService, BookService bookService) {
