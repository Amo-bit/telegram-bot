...
public class FantasticBookCommand extends Command {
    public final static String genre = "Фантастика";
    ...
    public FantasticBookCommand(SendBotMessageService sendBotMessageService, BookService bookService) {
